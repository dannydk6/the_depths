...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBoxLayoutWidget = QtGui.QWidget(self.centralwidget)
        self.comboBoxLayoutWidget.setGeometry(QtCore.QRect(465, 100, 100, 100))
        self.comboBoxLayoutWidget.setObjectName("comboBoxLayoutWidget")

        self.topLeftVerticalLayout2 = QtGui.QVBoxLayout(self.comboBoxLayoutWidget)
        self.topLeftVerticalLayout2.setSpacing(15)
        self.topLeftVerticalLayout2.setObjectName("topLeftVerticalLayout2")
        ...
        self.TPOXREP1_ComboBox.addItem("6")
        self.TPOXREP1_ComboBox.addItem("7")
        self.ComboBox = CheckableComboBox()

        for i in range(7):
            self.ComboBox.addItem(str(i+6))
            item = self.ComboBox.model().item(i, 0)
            item.setCheckState(QtCore.Qt.Unchecked)
        self.centralwidget.setLayout(myBoxLayout)
        self.topLeftVerticalLayout2.addWidget(self.ComboBox)
